...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\LivrablesController' => 'getLivrablesControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CompetencesRepository' => ['privates', 'App\\Repository\\CompetencesRepository', 'getCompetencesRepositoryService', true],
            'App\\Repository\\CritereAdmissionRepository' => ['privates', 'App\\Repository\\CritereAdmissionRepository', 'getCritereAdmissionRepositoryService', true],
            'App\\Repository\\CritereEvaluationRepository' => ['privates', 'App\\Repository\\CritereEvaluationRepository', 'getCritereEvaluationRepositoryService', true],
            'App\\Repository\\FabriqueRepository' => ['privates', 'App\\Repository\\FabriqueRepository', 'getFabriqueRepositoryService', true],
            ...
            'App\\Repository\\GroupeTagRepository' => ['privates', 'App\\Repository\\GroupeTagRepository', 'getGroupeTagRepositoryService', true],
            'App\\Repository\\GrpCompetencesRepository' => ['privates', 'App\\Repository\\GrpCompetencesRepository', 'getGrpCompetencesRepositoryService', true],
            'App\\Repository\\LangueRepository' => ['privates', 'App\\Repository\\LangueRepository', 'getLangueRepositoryService', true],
            'App\\Repository\\LivrablePartielleRepository' => ['privates', 'App\\Repository\\LivrablePartielleRepository', 'getLivrablePartielleRepositoryService', true],
            'App\\Repository\\LivrablesRepository' => ['privates', 'App\\Repository\\LivrablesRepository', 'getLivrablesRepositoryService', true],
            'App\\Repository\\NiveauxEvaluationRepository' => ['privates', 'App\\Repository\\NiveauxEvaluationRepository', 'getNiveauxEvaluationRepositoryService', true],
            ...
            'App\\Repository\\FabriqueRepository' => '?',
            'App\\Repository\\FormateurRepository' => '?',
            'App\\Repository\\GroupeRepository' => '?',
            'App\\Repository\\GroupeTagRepository' => '?',
            'App\\Repository\\GrpCompetencesRepository' => '?',
            'App\\Repository\\LangueRepository' => '?',
            'App\\Repository\\LivrablePartielleRepository' => '?',
            'App\\Repository\\LivrablesRepository' => '?',
            'App\\Repository\\NiveauxEvaluationRepository' => '?',
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H6o3G5OAi8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SnruPMM8lK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hSv+3yo-on', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pOtNvSE+51', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SM-5we+UTf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_profile_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_profile_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityProfileApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_referentiel_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_referentiel_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityReferentielApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_profile_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_referentiel_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rmDMR4dAMc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ierqnvZT4v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.collection.pagination.items_per_page' => 4,
